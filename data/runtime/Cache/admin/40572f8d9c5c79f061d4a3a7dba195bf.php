...
<DIV class=mod>
      <br><p><SPAN 
  class="h7">添加</SPAN></p>
  	<form action="<?php echo U('item/add');?>" method="post" target="_self">
      <TABLE style="FONT-SIZE: 14px" cellSpacing=0 cellPadding=0 border=0>
        <TBODY> 
        <TR> 
          <TD class=col1 align=right>名称：</TD>
          <TD class=col34> 
            <input type="text" class="input grayInput" name="itemname" value="">
            </TD>
        </TR>
       ...
       <TR>
          ...
          <TD class=col34><input type="text" class="input grayInput" name="order" value=""></TD>
        </TR>
        <TR>
